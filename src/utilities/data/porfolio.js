...
import DashboardIot from "../image/dashboard_aerport.png";
import MFT from "../image/MFT.png"
import DashboardIot2 from "../image/dashboard_aerport_1.png";
import parkFree from "../image/parkFree/parkFree.png"
...
import { Apple1, Apple2, Apple3, Coca1, Coca2, Coca3, Mammas1, Mammas2, Mammas3, Mammas4, PeopleHealth1, PeopleHealth2, PeopleHealth3, PeopleHealth4 } from '../image'
const PorfolioItems = [
  {
    id: 'MELBOURNE CBD FREE PARKING',
    name: 'MELBOURNE CBD FREE PARKING',
    category: ['All', 'React'],
    brief: 'Melbourne CBD Free Parking is a project helping Melburnians to find the closest free parking bay',
    desc: {
      'Main objective': 'Melbourne CBD Free Parking is a project helping Melburnians to find the closest free parking bay in the municipal of Melbourne CBD with the real-time data update every 2 minutes.',
      'Technologies used': 'Vite, ReactJS, Redux, Redux-logic, Axios, tailwind, headless ui',
      'API used': 'The live data is provided by city of melbourne open data:\n https://data.melbourne.vic.gov.au/explore/dataset/on-street-parking-bay-sensors/information\nThe restriction sign plates data is also from the city of melbourne open data: \nhttps://data.melbourne.vic.gov.au/explore/dataset/sign-plates-located-in-each-parking-zone/information/?rows=10000',
    },
    utilities: [parkFree],
    image: parkFree,
    link: 'https://parkfree.vercel.app/',
  },
  {
    id: 'Site ',
    name: '',
    ...
    desc: {
      'Main objective': 'Melbourne CBD Free Parking is a project helping Melburnians to find the closest free parking bay in the municipal of Melbourne CBD with the real-time data update every 2 minutes.',
      'Technologies used': '-Front-end: ReactJS, Wouter, Zustand, Mantine, Apollo Client \n-Back-end: Nestjs, GraphQl',
    },
    utilities: [MFT],
    image: MFT
  },
  {
    ...
    category: ['All', 'React'],
    brief: 'A single-pane, top-down view of all connected IoT devices',
    desc: {
      'Main objective': 'A single-pane, top-down view of all connected IoT devices throughout their lifecycle, identify problems, and take actions automatically―vastly reducing the amount of time and resources needed to manage your device deployment.',
      'Team Size': '15',
    ...
    utilities: [Iot, DashboardIot, DashboardIot2],
    image: Iot,
  },
  {
    id: 'apple-products',
